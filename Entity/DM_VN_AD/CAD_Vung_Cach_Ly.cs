...
{
    public class CAD_Vung_Cach_Ly
    {
		private int m_intAuto_ID;
		private string m_strTen_Vung;
		...
		public void ResetData()
		{
			...
			m_strTen_Vung = CConst.STR_VALUE_NULL;
		...
		public string Ten_Vung
		{
			get
			{
				return m_strTen_Vung;
			}
			set
			{
				m_strTen_Vung = value.Trim();
			}
		}
